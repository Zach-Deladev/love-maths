...
// Get the button elements and add event listenders to them 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("answer-boc").addEventListener("keydown", function (event) {
        if (event.key === "Enter") {
            checkAnswer();
        }
    })
...
function checkAnswer() {
    ...
    if (isCorrect) {
        alert("Hey! You got the it right! :D");
        incrementScore();
    } else {
